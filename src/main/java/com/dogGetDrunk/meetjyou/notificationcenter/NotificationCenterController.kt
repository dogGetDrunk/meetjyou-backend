...
class NotificationCenterController(
    ...
    fun getNotices(
        ...
        return notificationCenterService.getNotices(pageable)
    }
    ...
    fun markNoticesRead() {
        notificationCenterService.markNoticesRead()
    }
    ...
    fun getReceivedApplications(
        ...
        return notificationCenterService.getReceivedApplications(pageable)
    }
    ...
    fun markReceivedApplicationsRead() {
        notificationCenterService.markReceivedApplicationsRead()
    }
    ...
    fun getSentApplications(
        ...
        return notificationCenterService.getSentApplications(pageable)
    }
    ...
    fun markSentApplicationsRead() {
        notificationCenterService.markSentApplicationsRead()
    }
}
