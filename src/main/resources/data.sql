...
INSERT INTO notice (title, body)
VALUES ('서비스 점검 안내', '안녕하세요. 보다 나은 서비스를 제공하기 위해 3월 30일 01:00 ~ 05:00까지 점검이 진행됩니다.'),
       ('신규 기능 출시', '프로필 커스터마이징 기능이 새롭게 추가되었습니다. 지금 확인해보세요!'),
       ('이벤트 당첨자 발표', '3월 친구 초대 이벤트 당첨자를 발표합니다. 자세한 내용은 공지사항을 확인해주세요.'),
       ('앱 업데이트 안내', '최신 버전으로 업데이트하시면 더욱 안정적인 사용이 가능합니다.'),
       ('정책 변경 사전 안내', '개인정보 처리방침이 4월 1일부터 변경됩니다. 필히 확인 부탁드립니다.'),
       ('비정상 활동 제한', '비정상적인 활동이 감지된 계정에 대해 이용이 제한되었습니다. 문의는 고객센터로 부탁드립니다.'),
       ('명절 배송 일정 안내', '설 연휴 기간 동안 일부 상품 배송이 지연될 수 있습니다. 너그러운 양해 부탁드립니다.'),
       ('긴급 점검 공지', '서버 이슈로 인해 긴급 점검이 진행 중입니다. 빠르게 복구하겠습니다.'),
       ('회원 등급제 도입', '활동량에 따라 등급이 나뉘는 회원 등급제가 도입되었습니다. 다양한 혜택을 누려보세요.'),
       ('커뮤니티 이용 가이드', '건강한 커뮤니티를 위해 이용 가이드를 확인해주세요. 위반 시 제재될 수 있습니다.');
