-- user
INSERT INTO user (uuid, email, nickname, bio, participation, img_url, thumb_img_url, notified,
                  last_login_at, updated_at, auth_provider, external_id, status, role)
VALUES ('6faff71a-52ac-41e7-aa48-64a021f829fa', 'alice@example.com', '김민지', '여행과 독서를 좋아합니다.', 5,
        'https://example.com/img1.jpg', 'https://example.com/thumb1.jpg', 1, NOW(), NOW(), 'KAKAO', '2683927412', 'NORMAL', 'USER'),
       ('70bff056-fe9c-4416-9c0b-a122c84bedaa', 'bob@example.com', '이준호', '', 3,
        'https://example.com/img2.jpg', 'https://example.com/thumb2.jpg', 1, NOW(), NOW(), 'GOOGLE', '10769150350006150715113082367', 'NORMAL', 'ADMIN'),
       ('55f5807e-fea1-4135-a165-689c6155a190', 'charlie@example.com', '박서연', '사진 촬영이 취미입니다.', 8,
        'https://example.com/img3.jpg', 'https://example.com/thumb3.jpg', 1, NOW(), NOW(), 'KAKAO', '1901740850', 'NORMAL', 'USER'),
       ('1ba03218-5617-40ed-a3fa-595583a5dcd4', 'dave@example.com', '최민수', '도시 탐방을 즐깁니다.', 6,
        'https://example.com/img4.jpg', 'https://example.com/thumb4.jpg', 1, NOW(), NOW(), 'KAKAO', '2984075634', 'NORMAL', 'ADMIN'),
       ('1f83329d-47bf-4a85-a25d-33587fe0c475', 'eva@example.com', '정다은', '요가와 명상을 좋아합니다.', 2,
        'https://example.com/img5.jpg', 'https://example.com/thumb5.jpg', 1, NOW(), NOW(), 'GOOGLE', '113674829001507123456', 'NORMAL', 'USER'),
       ('59d901f6-2f8d-4c2f-afe0-2b7c9dc1ed3e', 'frank@example.com', '한지훈', '', 4,
        'https://example.com/img6.jpg', 'https://example.com/thumb6.jpg', 1, NOW(), NOW(), 'KAKAO', '2741839051', 'NORMAL', 'ADMIN'),
       ('cccac2a7-58d6-4c57-91b6-9f14e364b42a', 'grace@example.com', '김수현', '캠핑과 하이킹을 좋아합니다.', 9,
        'https://example.com/img7.jpg', 'https://example.com/thumb7.jpg', 1, NOW(), NOW(), 'GOOGLE', '108912377165432871234', 'NORMAL', 'USER'),
       ('2d58f7e2-e290-490c-a84c-74c8ac7fefba', 'henry@example.com', '이서준', '배낭여행을 준비 중!', 7,
        'https://example.com/img8.jpg', 'https://example.com/thumb8.jpg', 1, NOW(), NOW(), 'KAKAO', '3107892449', 'NORMAL', 'ADMIN'),
       ('c37d126c-dbe0-41f5-b293-94b2311b3a1a', 'isabel@example.com', '박하늘', '도전하는 삶!', 5,
        'https://example.com/img9.jpg', 'https://example.com/thumb9.jpg', 1, NOW(), NOW(), 'GOOGLE', '115308721400089176543', 'NORMAL', 'USER'),
       ('e4fe1a8b-8750-49e7-96f2-9e50c14765f3', 'jack@example.com', '최예린', '세상을 탐험 중', 1,
        'https://example.com/img10.jpg', 'https://example.com/thumb10.jpg', 1, NOW(), NOW(), 'KAKAO', '2536089943', 'NORMAL', 'ADMIN');
